...
class InverseMlpOffset(Mlp):
    ...
    def setup(self):
        ...
        self.offset_param = self.param('offset_param', lambda rng: jax.random.uniform(rng, (1,), minval=jnp.log(0.01), maxval=jnp.log(0.1))) #minval=jnp.log(0.01), maxval=jnp.log(0.1)))
